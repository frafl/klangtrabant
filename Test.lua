...
local Pattern = require("klangtrabant.Pattern")

local testBin = string.char(
                ...
                0x16, 0x01, 0xb1, 0xbe,                 -- playoid 45502
                            ...
                            0x00, 0x62, 0x03, 0x01, 0x00, 0x3c, 0x2e, 0x93, 0x0e, 0x00, 0x00, 0xd0, 0x03, 0x01, 0x00, 0x3c)..string.char(
...
local da=Disassembler(testBin)
local daTest = da:disassemble()
print(daTest)
local as=Assembler(daTest)
local asTest = as:assemble()
print(da:disassemble(asTest))
...
local var = Macro("var()v31 mend")

local dpow = pow + mul
print(pow,"\n------")
print(dpow,"\n------")
print(pow.apply("pow v3,v4,v0,v1,v2,pl\n"),"\n-------")
print(mul.apply(pow.apply("pow v1,v2,v0,v3,v4,pl\n")))
